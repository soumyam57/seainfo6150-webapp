...
const Article = () => {
  return (
    ...
    <div>
      ...
      <i>by Kate Farley ( <a href="mailto:kate.farley@nytimes.com">kate.farley@nytimes.com</a>)</i><br></br>November 22, 2018
      ...
      <blockquote>
        Give me your tired, your poor<br></br>Your huddled masses yearning to breathe free.
      </blockquote>
      ...
      <li>otal weight of the Statue of Liberty is <b>225 tons (or 450,000 pounds)</b></li>
      </ul>
    </div>
  )
}
