...
const Article = () => {
  return (
    ...
    <div>  
      <h1 style={{color:'#00001A'}}>The Statue of Liberty's torch heads to new museum </h1> 
      
      <small style={{color:'#787878'}}>By Kate Farley  
        <a style={{color:'#787878'}} href ="kate.farley@nytimes.com">(kate.farley@nytimes.com)</a>, 
        <time> November 22, 2018 </time>
      </small>
      
      <h3 style={{color:'#03102E'}}>The Statue of Liberty's original torch is getting a new home</h3>
      ...
      <h3 style={{color:'#03102E'}}>The history of the Statue of Liberty</h3>
      ...
      <span>The inspiration gallery, which is where the torch will live, will have floor-to-ceiling glass windows looking out at Lower Manhattan, including the World Trade Center.</span>

      <h3 style={{color:'#03102E'}}>Some facts about the Statue of Liberty</h3>
